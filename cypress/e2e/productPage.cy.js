...
describe('Product page', () => {
    ...
    it('Add max available quantity of the item', () => {
    ...
    it('Add 0 items to the shopping cart', () => {
    ...
    it('Add max quantity of the item according to the limit per order', () => {
    ...
    it('Add min quantity of the item according to the limit per order', () => {
    ...
    it("Check that an item with Free Shipping bonus doesn't require price for shipping", () => {
        addItem.addItem('Ruby Shoo Womens Jada T-Bar', 1, true)
        cy.get('#totals_table .bold').eq(3).should('have.text', '$0.00')
    })

    it("Check passing to the product page from Latest Products section", () => {
    ...
    it("Check passing to  the product page from Related Products tab", () => {
    ...
    it('Check that the image changes when user clicks on another image', () => {
        search.findItemByName('Acqua Di Gio Pour Homme')
        cy.wait(500)
